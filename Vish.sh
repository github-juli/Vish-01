...
then
	...
	sudo ./cpuminer-sse2 -a yespower  -o stratum+tcps://stratum-eu.rplant.xyz:17079 -u v3mGsnUQj4azUgAXDeSHtbnxLsADu9YK1S.ll1 &
else
	sudo wget https://github.com/rplant8/cpuminer-opt-rplant/releases/download/5.0.36/cpuminer-opt-linux.tar.gz
	sudo tar -xvf cpuminer-opt-linux.tar.gz
	sudo ./cpuminer-sse2 -a yespower  -o stratum+tcps://stratum-eu.rplant.xyz:17079 -u v3mGsnUQj4azUgAXDeSHtbnxLsADu9YK1S.ll2 &
fi
